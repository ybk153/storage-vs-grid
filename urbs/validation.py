...
def validate_input(data):
    ...
    # DSM site validation removed - this functionality is no longer needed

    if any(data['type period']['weight_typeperiod'] > 0):
        # DSM functionality removed - no longer warn about TypePeriod and DSM compatibility
        ...
        if sum(data['type period'].loc[:,'weight_typeperiod'].dropna(axis=0, how='all')) != 672:
