...
def storage_cost(m, cost_type):
    ...
    if cost_type == 'Invest':
        cost = sum(m.cap_sto_p_new[s] *
                   ...
                   m.storage_dict['invcost-factor'][s]
                   for s in m.sto_tuples) - sum(m.cap_sto_c_decommissioned[s] *
...
# DSM functionality removed - demand side management no longer needed
# This section previously contained DSM variables, constraints, and helper functions


# Removed add_dsm function - DSM functionality no longer needed


# Removed DSM constraint functions:
# - def_dsm_variables_rule
# - res_dsm_upward_rule  
# - res_dsm_downward_rule
# - res_dsm_maximum_rule
# - res_dsm_recovery_rule
# - dsm_surplus
# - dsm_down_time_tuples
# - dsm_time_tuples
# - dsm_recovery
