        ...
        for stf, sit, com in report_tuples:
            ...
            for lv in help_sit:
                (created, consumed, stored, imported, exported,
                 voltage_angle, voltage_magnitude) = get_timeseries(instance, stf, com, lv)  # DSM removed
                ...
                tableau = pd.concat(
                    ...
                    keys=['Created', 'Consumed', 'Storage',
                          ...
                          'Voltage Angle', 'Voltage Magnitude[pu]'])  # DSM removed
                help_ts[(stf, lv, com)] = tableau.copy()

                # timeseries sums (DSM removed)
